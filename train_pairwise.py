...
if __name__ == "__main__":
    ...
    train_input_examples = make_input_examples(train_pairs, n_workers=16)

    valid_input_examples = make_input_examples(dev_pairs, n_workers=16)
